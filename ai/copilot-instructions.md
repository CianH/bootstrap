...
- **NEVER hard-wrap commit message bodies.** Each paragraph must be a single unwrapped line — no manual line breaks at 72 chars or any other width. The only permitted line breaks are between paragraphs (blank line) or for bullet/list items. This overrides the conventional 72-char git commit convention. Wrapping is WRONG. <!-- added:2026-03-04 cited:3 source:explicit -->
