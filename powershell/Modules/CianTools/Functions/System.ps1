...
function New-SymbolicLink {
    <#
    .SYNOPSIS
        Creates a symbolic link using the Windows mklink command.
    
    .DESCRIPTION
        Creates a symbolic link to a file using the native Windows mklink command.
        This is a wrapper around 'cmd /c mklink' for easier use from PowerShell.
...
function New-DirectoryLink {
    <#
    .SYNOPSIS
        Creates a directory symbolic link using the Windows mklink command.
    
    .DESCRIPTION
        Creates a symbolic link to a directory using the native Windows mklink /D command.
        This is a wrapper around 'cmd /c mklink /D' for easier use from PowerShell.
